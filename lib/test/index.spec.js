...
describe('mock-type', function () {
    ...
    it('should support enum:', function () {
        chai_1.expect(typeof (output.enum)).to.equal('number');
    });
    it('should support intersection type:', function () {
        chai_1.expect(typeof (output.intersectionType)).to.equal('object');
        chai_1.expect(typeof (output.intersectionType.age)).to.equal('number');
        chai_1.expect(typeof (output.intersectionType.title)).to.equal('string');
    });
});
